...
public class EDB {
  ...
  public static final String HEADING_TYPE = "t"; // "type";
  public static final String HEADING_VALUE = "v"; // "value";
  ...
  public static final String HEADING_PUBLIC_ID = "pid"; // "public_id";
  ...
  public static final String HEADING_DESCRIPTION = "ds"; // "description";
  ...
  public static final String HEADING_ORGANISM = "o"; // "organism";
  ...
  /**
   * Checks that a parameter consists only of digits. If the id is invalid, -1
   * will be returned.
   * 
   * @param idParameter
   * @return
